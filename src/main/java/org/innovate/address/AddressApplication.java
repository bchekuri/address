package org.innovate.address;

import org.innovate.address.helper.AddressHelper;
...
public class AddressApplication {
	...
	public static final Logger LOG = LoggerFactory.getLogger(AddressApplication.class);
	public static void main(String[] args) {
		System.out.println(AddressHelper.tokenize("8200 Plano Ln 6379 MacLine TX 75036").toString());
	...
	public Docket apiInfo() {
		ApiInfo apiInfo = new ApiInfo("address",
				"US Address processor",
				"1.0",
				"",
				new Contact("bc", "", "bc@outlook.com"),
				"MIT",
				"",
